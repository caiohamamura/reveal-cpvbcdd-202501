# Workflow: Converter PPTX → Reveal.js (pasta `ia/`)

Base de instruções para converter as apresentações PowerPoint desta pasta em decks
Reveal.js do framework CPVBCDD. Validado na conversão da Aula 01
(`aula01-introducao-ia.html`) — use esse arquivo como referência de estilo.
