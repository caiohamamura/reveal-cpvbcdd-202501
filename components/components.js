...
const pollQuestionComponent = {
  ...
  <div>
      ...
      <div v-if="answer" ref="answerRef" class="fragment" data-fragment-index="1" style="background: #50fa7b20; border: 1px solid #50fa7b; padding: 8px; margin-top: 8px; border-radius: 8px; font-size:0.5em">
